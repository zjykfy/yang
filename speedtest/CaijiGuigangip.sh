...
case $city_choice in
    1)
        city="Guigang_dianxin"
        stream="/tsfile/live/1010_1.m3u8"
        channel_key="贵港"
        url_fofa=$(echo  'city="Guigang" && org="Chinanet" && port="8181" && protocol="http"' | base64 |tr -d '\n')
...
#echo "贵港,#genre#" >zubo.txt
#cat txt/Guigang_dianxin.txt >>zubo.txt
